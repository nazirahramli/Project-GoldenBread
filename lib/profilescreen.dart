...
import 'package:goldenbread/storecredit.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: CachedNetworkImage(
                              fit: BoxFit.cover,
                              imageUrl:
                                  "http://seriouslaa.com/goldenbread/profileimage/${widget.user.email}.jpg?",
  ...
  void _takePicture() async {
    ...
    if (_image == null) {
      ...
      print(base64Image);
      http.post("https://seriouslaa.com/goldenbread/php/upload_image.php",
          body: {
  ...
  _changeName(String name) {
    ...
    http.post("https://seriouslaa.com/goldenbread/php/update_profile.php",
        body: {
          "email": widget.user.email,
